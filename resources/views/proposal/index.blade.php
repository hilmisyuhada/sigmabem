            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="text-sm text-gray-700">
                    <tr class="border-b border-gray-100 hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 font-medium text-gray-900">SIGMA BEM</td>
                        <td class="px-6 py-4">2026-07-13</td>
                        <td class="px-6 py-4 text-center">
                            <!-- Link ke halaman detail -->
                            <a href="/proposal-detail-test" class="inline-flex items-center gap-1 bg-purple-500 hover:bg-purple-600 text-white px-3 py-1.5 rounded-full text-xs font-medium transition">
                        ...
                        <td class="px-6 py-4 flex justify-center gap-2">
                            ...
                            <button class="bg-red-800 hover:bg-red-900 text-white px-3 py-1.5 rounded-lg text-xs font-medium transition flex items-center gap-1">
